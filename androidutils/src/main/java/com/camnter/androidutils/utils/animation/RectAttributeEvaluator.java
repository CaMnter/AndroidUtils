package com.camnter.androidutils.utils.animation;
 ...
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class RectAttributeEvaluator
        implements TypeEvaluator<RectAttribute> {
